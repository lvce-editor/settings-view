...
test('handleWheel clamps to max based on content height minus viewport', () => {
  const state = {
    ...createDefaultState(),
    filteredItems: [
      { category: '', description: '', errorMessage: '', hasError: false, heading: '', id: 'a', modified: false, type: SettingItemType.String, value: '' },
      { category: '', description: '', errorMessage: '', hasError: false, heading: '', id: 'b', modified: false, type: SettingItemType.String, value: '' },
      { category: '', description: '', errorMessage: '', hasError: false, heading: '', id: 'c', modified: false, type: SettingItemType.String, value: '' },
    ],
    height: 600,
    itemHeight: 100,
  }
